...
Invoke-WebRequest -Uri "https://github.com/azure/arc_jumpstart_levelup/blob/main/docs/azure_arc_servers_jumpstart/AzureArcLevelupNotebook.dib" -OutFile ./AzureArcLevelupNotebook.dib
