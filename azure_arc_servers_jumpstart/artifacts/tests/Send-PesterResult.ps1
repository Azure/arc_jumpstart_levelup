...
$null = Connect-AzAccount -Identity -Tenant $env:spntenantId -Subscription $env:subscriptionId -Scope Process
...
# Bug? When using #, not further commands is executed. ";" added between all lines.
# Insufficient privileges to complete the operation.
# $ClientObjectId = (Get-AzADApplication -ApplicationId $env:spnClientId).Id
# $ClientObjectId = "c15bcbe0-86cb-4e98-9f7e-191f369c8748"
# New-AzRoleAssignment: Operation returned an invalid status code 'BadRequest' - assigned role manually
# New-AzRoleAssignment -ObjectId $ClientObjectId -RoleDefinitionName "Storage Blob Data Contributor" -Scope $StorageAccount.Id
